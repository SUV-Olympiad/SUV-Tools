    ...
    def on_frame(self, controller):
        ...
        for hand in frame.hands:
            if hand.is_right:
                ...
                self.rh_value = (roll_value, pitch_value, yaw_value, wrist_height, grap_value)
        # 오른손 안나오면 전부 0
        ...
        # print("Roll : ", self.rh_value[0])
        # print("Pitch  : ", self.rh_value[1])
        # print("Yaw: ", self.rh_value[2])
        # print("Height   : ", self.rh_value[3])
